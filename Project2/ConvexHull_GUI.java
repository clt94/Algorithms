	...
	public static void main(String[] args) {
		...
		if (generateData){
			...
			for(int i = 10; i <= 1000000; i *= 10){
				CH.testFileGen("rectangle" + i + ".txt", "rectangle", i);
				CH.testFileGen("circle" + i + ".txt", "circle", i);
				CH.testFileGen("onCircle" + i + ".txt", "onCircle", i);
				CH.testFileGen("triangle" + i + ".txt", "triangle", i);
			}
			...
			String dataFile = "rectangle10.txt";
			String hullFile = "hull_G_rectangle10.txt";
